function [segmentation,E2]=ICM(image,class_number,potential,maxIter)
...
firstlabel=reshape(segmentation,[width,height]);
figure;
imshow(firstlabel,[])
clear c;
iter=0;
while(iter<maxIter)
    ...
    E2=EnergyOfLabelField_update(segmentation,potential,width,height,class_number);
    E=Ef+E1;
